...
with st.form("arve_form"):
    ...
    klient_kmkr = st.text_input("Kliendi KMKR", "")
    ...
    for i in range(1, 6):
        ...
        with col2:
            ...
            try:
                ...
                kogus = 0.0
                st.error(f"Kogus {i}: Sisesta korrektne number (nt 3,5)")
        ...
        with col3:
            ...
            try:
                ...
                hind = 0.0
                st.error(f"Hind {i}: Sisesta korrektne number (nt 12,99)")
...
if submitted and arveread:
    ...
    html_out = html_template.render(
        ...
        klient_kmkr=klient_kmkr,  # ← lisatud väli
        read=arveread,
